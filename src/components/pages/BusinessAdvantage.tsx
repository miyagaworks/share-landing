...
export default function BusinessAdvantage() {
  ...
  const businessScenarios = [
    ...
    },
    {
      title: "ビジネスミーティング",
      description:
        "初対面の相手に革新的な印象を与えます。紙の名刺とQRコードを併用することで、従来の礼儀正しさと先進性を両立。会議後すぐにSNSでつながることができます。",
  ...
  const differentiators = [
    ...
    },
    {
      title: "情報の豊富さと更新性",
      description:
        "紙の名刺に収まらない豊富な情報を提供できます。役職や所属が変わっても、プロフィールを更新するだけで常に最新の情報を共有できます（役職・所属の登録は法人プランの機能です）。",
      icon: (
        <path
          strokeLinecap="round"
          strokeLinejoin="round"
    ...
    },
    {
      title: "時間とコストの節約",
      description:
        "紙の名刺の印刷コストと管理の手間を削減。情報が変わるたびに新しい名刺を印刷する必要がありません。",
      icon: (
        <path
          strokeLinecap="round"
          strokeLinejoin="round"
              ...
              <div className="md:w-3/4 md:pl-8">
                ...
                <div className="mt-6 p-4 bg-blue-50 rounded-lg">
                  ...
                  <p className="text-gray-700 text-justify">
                    ...
                    {activeTab === 2 &&
                      "マーケティング・PR担当者は、ブランドの世界観を反映したデザインを使用し、各種SNSへの誘導を一元化することで、マルチチャネルでのフォロワー獲得につなげられます。"}
                    {activeTab === 3 &&
        ...
        <section className="mb-16">
          ...
          <div className="space-y-4">
            ...
            <div className="bg-white p-6 rounded-lg shadow-md border border-gray-200">
              ...
              <p className="text-gray-600 text-justify">
                業種を問わず利用できますが、特に人との接点が多い営業職、IT/テクノロジー関連、クリエイティブ業界、コンサルタント、経営者/役員などで活用しやすい機能構成です。展示会や商談、カンファレンスなど、多くの人と名刺を交換する場面で使いやすくなっています。
              </p>
            </div>
          </div>
        </section>
