// src/components/pages/DigitalNamecardContent.tsx
"use client";
...
// デジタル名刺とは何かを説明するためのメインコンテンツコンポーネント
export default function DigitalNamecardContent() {
          ...
          <div className="md:flex items-center">
            <div className="md:w-1/2 mb-8 md:mb-0">
              ...
              <p className="text-blue-50 text-justify">
                デジタル名刺（電子名刺）は、従来の紙の名刺をデジタル化したもので、複数のSNSアカウントや連絡先情報を一つにまとめ、QRコードで簡単に共有できる先進的なビジネスツールです。Share（シェア）のデジタル名刺サービスは、ビジネスシーンでの差別化とスマートな印象を提供します。
              </p>
            </div>
        ...
        <section className="bg-gradient-to-r from-primary to-blue-600 text-white rounded-xl p-8 shadow-lg">
          <div className="md:flex items-center justify-between gap-8">
            <div className="mb-6 md:mb-0 md:max-w-lg">
              ...
              <p className="text-blue-100 max-w-xl text-justify">
