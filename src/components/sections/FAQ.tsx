...
export default function FAQ() {
  ...
  const faqItems: FAQItem[] = [
    ...
    },
    {
      ...
      answer:
        "はい、法人向けプランをご用意しています。最大10名まで利用できるスタータープラン（月額3,300円）と、最大30名まで利用できるビジネスプラン（月額6,600円）、そして最大50名まで利用できるエンタープライズプラン（月額9,900円）があります。会社ロゴの表示や共通カラーテーマの設定、管理者ダッシュボードなど、法人向けの機能が含まれています。",
      category: "料金・プラン",
    },
    {
      id: "data-security",
  ...
  return (
    <section
      id="faq"
      className="py-16 bg-gradient-to-b bg-blue-50 overflow-hidden"
    >
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center mb-10">
          ...
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            Shareサービスに関するよくあるご質問と回答をまとめました。
        ...
        {/* <div className="mt-8 text-center">
          <Link
            href="/support/faq"
            className="inline-flex items-center text-primary hover:text-blue-700 text-lg font-medium transition-colors"
          >
            すべてのFAQを表示
            <svg
