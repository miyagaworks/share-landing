...
export default function FAQ() {
  ...
  const faqItems: FAQItem[] = [
    ...
    },
    {
      ...
      answer:
        "はい、法人向けプランをご用意しています。最大10名まで利用できるスタータープラン（月額3,300円）と、最大30名まで利用できるビジネスプラン（月額6,600円）、そして最大50名まで利用できるエンタープライズプラン（月額9,900円）があります。チーム管理機能や企業ブランディングの統一など、法人向けの機能が含まれています。",
      category: "料金・プラン",
    },
    {
      id: "data-security",
