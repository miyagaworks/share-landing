...
export default function SNSIntegrationBusinessCard() {
  ...
  const snsPlatforms = [
    ...
    },
    {
      ...
      name: "LinkedIn",
      description:
        "プロフェッショナル向けSNS。ビジネスネットワーキングや採用活動に最適。",
      businessUse:
        "ビジネスネットワーキング、リクルーティング、BtoBマーケティング",
      tips: "詳細なプロフィールを作成。関連業界のつながりを積極的に構築。",
      icon: (
        <svg className="w-6 h-6" viewBox="0 0 24 24" fill="currentColor">
  ...
  const faqData = [
    ...
    },
    {
      ...
      answer:
        "LINE、YouTube、X（旧Twitter）、Instagram、TikTok、Facebook、Pinterest、Threads、note、BeRealなど、主要なSNSプラットフォームに対応しています。さらに、カスタムリンクを追加することで、その他のサービスやウェブサイトも登録できます。",
    },
    {
          ...
          <div className="md:flex items-center">
            <div className="md:w-2/3 mb-8 md:mb-0">
              ...
              <p className="text-blue-50 text-justify">
                LINE、X（旧Twitter）、Instagram、Facebookなど、複数のSNSアカウントを運用している方が増えています。
              ...
              <div className="bg-white/10 rounded-xl p-5">
                <div className="bg-white rounded-lg shadow-lg overflow-hidden">
                  ...
                  <div className="p-4 space-y-3">
                    {["LINE", "X", "Instagram", "Facebook", "LinkedIn"].map(
                      (sns, index) => (
                        <div
                          key={index}
              ...
              <ul className="space-y-3">
                <li className="flex items-start">
                  ...
                  <div className="ml-3">
                    ...
                    <p className="text-gray-600 text-sm">
                      LinkedIn、Xなどを上位に設定し、プロフェッショナルな印象を与える
                    </p>
                  </div>
                </li>
                <li className="flex items-start">
