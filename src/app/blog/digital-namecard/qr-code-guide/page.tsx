...
export default function QRCodeNamecardGuide() {
  ...
  const designPatterns = [
    ...
    },
    {
      title: "クリエイティブ統合型",
      description:
        "QRコードをデザインの一部として創造的に組み込むパターン。ロゴやイラストとQRコードを融合させます（別途デザインツールが必要です）。",
  ...
  const advancedTips = [
    {
      title: "カラーカスタマイズ",
      description:
        "一般に、QRコードは白黒以外の配色でも生成できるとされています。ただし、コントラストが十分あることを確認しましょう。（Share（シェア）が生成するQRコードの配色変更には対応していません）",
    },
    {
      title: "ロゴ埋め込み",
      description:
        "一般に、QRコードの中央にロゴを配置するとブランドの認知度を高められます（別途デザインツールが必要です）。読み取りエラーを防ぐためにテストは必須です。",
    },
    {
      title: "季節限定デザイン",
      description:
        "サービスによっては、季節やキャンペーンに合わせてQRコードデザインを変更できるものもあります。",
    },
  ];
  ...
  const trends2025 = [
    ...
    },
    {
      title: "デジタル名刺アプリとの連携",
      description:
        "業界全体では、QRコードを通じてデジタル名刺アプリに直接つながる仕組みが進化しています。Eight（エイト）などのアプリと連携するサービスもあり、紙とデジタルの両方のメリットを活かす名刺交換が広がりつつあります。なお、Share（シェア）はこれらのアプリとの連携機能を提供していません。",
      icon: (
        <svg
          className="w-10 h-10 text-primary"
          fill="none"
    ...
    },
    {
      title: "AR対応QRコード",
      description:
        "業界では、拡張現実（AR）技術と組み合わせたQRコードも登場しています。スキャンすると3Dのプロフィールや製品デモが表示されるなど、インタラクティブな体験を提供するものです。",
      icon: (
        <svg
          className="w-10 h-10 text-primary"
          fill="none"
    ...
    },
    {
      title: "デザイン性の向上",
      description:
        "業界では、QRコードのデザイン技術が進化し、ブランドのアイデンティティを反映した芸術的なQRコードが増加しています。単なる四角形のコードから脱却し、円形やカスタム形状のQRコードも登場しています。",
      icon: (
        <svg
          className="w-10 h-10 text-primary"
          fill="none"
  ...
  const faqData = [
    ...
    {
      question: "一般にQRコードの色は変更できますか？",
      answer:
        "Share（シェア）ではQRコードの配色変更に対応していません。一般論としては、背景色とQRコードの色のコントラスト比が30%以上あることが推奨されます。また、明るい背景に暗い色のQRコード、またはその逆が最も読み取りやすくなります。カラーカスタマイズを行う場合は、必ず複数のデバイスでスキャンテストを行ってください。",
    },
    {
      question: "QRコードにロゴを入れても大丈夫ですか？",
      answer:
        "Share（シェア）が生成するQRコードにロゴを埋め込む機能は提供していません。一般論として、QRコードは一定のエラー訂正機能を持っているため、中央部分などにロゴを配置することは可能です。ただし、QRコードの情報量やエラー訂正レベル、ロゴのサイズによって読み取り精度が変わるため、実装後は必ず複数環境でテストを行うことをお勧めします。",
    },
    {
    ...
    <div className="bg-white">
      ...
      <div className="max-w-6xl mx-auto px-4 py-12">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 mb-10">
            ...
            <div className="bg-white p-6 rounded-lg shadow-md border border-gray-200 relative">
              ...
              <div className="relative z-10">
                ...
                <p className="text-gray-600 text-justify">
                  QRコードが指すデジタルプロフィールの情報はいつでも更新可能。QRコード自体は変更せずに最新情報を提供できます。
                </p>
              </div>
            </div>
            <div className="bg-white p-6 rounded-lg shadow-md border border-gray-200 relative">
              ...
              <div className="relative z-10">
                ...
                <p className="text-gray-600 text-justify">
                  QRコードをスキャンするだけで、その場でSNSでつながることができます。後からの連絡先入力の手間を省けます。
                </p>
              </div>
            </div>
          </div>
                ...
                <ul className="space-y-2">
                  ...
                  <li className="flex items-start">
                    ...
                    <div className="ml-2">
                      ...
                      <p className="text-gray-600 text-sm">
                        一般に、ロゴ挿入や装飾を行う場合は、高いエラー訂正レベル（H：30%）が推奨されます。
                      </p>
                    </div>
                  </li>
                </ul>
        ...
        <section id="tips" className="mb-16 scroll-mt-16">
          ...
          <div className="bg-gray-50 p-6 rounded-xl mb-8">
            <p className="text-gray-700 text-justify">
              以下はQRコード全般についての一般的な知識です。Share（シェア）が生成するQRコードは、配色の変更・ロゴの埋め込み・デザインの変更には対応していません。
            </p>
          </div>
              ...
              <div>
                ...
                <ul className="list-disc pl-5 space-y-2 text-gray-600">
                  ...
                  <li>
                    ...
                    ：ロゴやアートワークをQRコードに組み込み（別途デザインツールが必要）、デザインスキルを示す
                  </li>
                  <li>
        ...
        <section id="trends" className="mb-16 scroll-mt-16">
          ...
          <div className="bg-gradient-to-r from-blue-600 to-indigo-700 text-white p-6 rounded-xl">
            ...
            <p className="text-white/90 text-justify mb-4">
              2025年に向けて、QRコード名刺の技術は業界全体で進化しています。デジタル名刺アプリとの連携が強化されたサービスや、AR技術との組み合わせにより立体的なプロフィールを表示するサービスも登場しています。
            </p>
